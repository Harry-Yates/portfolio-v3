...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col items-start justify-start min-h-screen bg-[#F7F7F7] px-20 max-w-5xl">
      <header className="w-full mx-auto flex flex-col justify-between items-start pt-12 pb-12">
